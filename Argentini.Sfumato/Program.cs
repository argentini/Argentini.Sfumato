...
internal class Program
{
	private static async Task Main(string[] args)
	{
		...
		await Console.Out.WriteLineAsync($"Version {version} for {Identify.GetOsPlatformName()} (.NET {Identify.GetRuntimeVersion()}/{Identify.GetProcessorArchitecture()}) / {runner.AppState.UtilityClassCollection.Count:N0} Utility Clases");
