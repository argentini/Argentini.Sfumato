        ...
        {
            {
                "mask-linear-from-", new ClassDefinition
                {
                    ...
                    Template =
                        ...
                        """,
                    UsesCssCustomProperties = [ "--sf-mask-linear-stops", "--sf-mask-linear-position", "--sf-mask-linear-to-color", "--sf-mask-linear-from-color", "--sf-mask-linear-to-position", "--sf-mask-linear", "--sf-mask-linear-from-position", "--spacing", "--sf-mask-radial", "--sf-mask-conic" ]
                }
            },
            {
                "mask-linear-to-", new ClassDefinition
                {
                    ...
                    Template =
                        ...
                        mask-composite: intersect;
                        """,
                    UsesCssCustomProperties = [ "--sf-mask-linear-stops", "--sf-mask-linear-position", "--sf-mask-linear-from-color", "--sf-mask-linear-from-position", "--sf-mask-linear", "--sf-mask-linear-to-color", "--sf-mask-linear-to-position", "--spacing", "--sf-mask-radial", "--sf-mask-conic" ]
                }
            },
            {
