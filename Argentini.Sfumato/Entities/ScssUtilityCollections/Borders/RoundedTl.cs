...
public class RoundedTl : ScssUtilityClassGroupBase 
{
    ...
    public override string GetStyles(CssSelector cssSelector)
    {
        ...
        if (ProcessDictionaryOptions(cssSelector.AppState.RoundedOptions, cssSelector, "border-top-left-radius: {value};", out Result))
            return Result;
        ...
        if (ProcessArbitraryValues("length,percentage", cssSelector, "border-top-left-radius: {value};", out Result))
            return Result;
