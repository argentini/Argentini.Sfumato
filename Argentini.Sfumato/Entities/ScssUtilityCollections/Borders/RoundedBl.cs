...
public class RoundedBl : ScssUtilityClassGroupBase 
{
    ...
    public override string GetStyles(CssSelector cssSelector)
    {
        ...
        if (ProcessDictionaryOptions(cssSelector.AppState.RoundedOptions, cssSelector, "border-bottom-left-radius: {value};", out Result))
            return Result;
        ...
        if (ProcessArbitraryValues("length,percentage", cssSelector, "border-bottom-left-radius: {value};", out Result))
            return Result;
