...
public class ContentScannerTests(ITestOutputHelper testOutputHelper)
{
    ...
    private static string Markup => """
                                    ...
                                    <body class="content-['test'] content-[''] phab:hover:text-xs theme-midnight:text-lime-950 @(true ? "xl:text-base/[3rem]" : "dark:text-base/5") [-webkit-backdrop-filter:blur(1rem)]">
    ...
    public void FileContentParsing()
    {
        ...
        Assert.Equal(47, utilityClasses.Count);
    }
