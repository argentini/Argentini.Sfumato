...
public class MaxWidthTests(ITestOutputHelper testOutputHelper)
{
    [Fact]
    public void MaxWidth()
    {
        ...
        var testClasses = new List<TestClass>()
        {
            ...
            new ()
            {
                ...
                IsValid = true,
                IsImportant = false,
                UsedCssCustomProperties = [ "--breakpoint-sm", "--breakpoint-md", "--breakpoint-lg", "--breakpoint-xl", "--breakpoint-2xl" ]
            },
        };
