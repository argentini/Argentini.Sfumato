...
public class InsetShadowColorTests(ITestOutputHelper testOutputHelper)
{
    [Fact]
    public void InsetShadowColor()
    {
        ...
        var testClasses = new List<TestClass>
        {
            new()
            {
                ...
                IsValid = true,
                IsImportant = false,
                UsedCssCustomProperties = [ "--sf-inset-shadow-color" ]
            },
            new()
            {
                ...
                IsValid = true,
                IsImportant = false,
                UsedCssCustomProperties = [ "--color-lime-500", "--sf-inset-shadow-color" ]
            },
            new()
            {
